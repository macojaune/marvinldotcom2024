...
updatedAt: 2024-10-17T20:12:00.648Z
---
...
![v0 by vercel](../../assets/lejustecoin/screen1-v0.png)
![jeu par v0  by vercel](../../assets/lejustecoin/screen-v0.png)

Alors bien évidemment, c'est grace à mes talents de prompt engineer _(comment ça les chevilles ?)_ en herbe.
...
J'ai utilisé un nouveau service dont j'ai vu l'efficacité sur youtube _(learn everyday)_. Convex, c'est un genre de Firebase en plus cool, je trouve.
...
![Statistiques de visites du site ](../../assets/lejustecoin/lejustecoin-screenUmami.jpg)
...
Assez content du résultat, j'ai déjà pu améliorer quelques éléments selon les retours que j'ai reçu et pour le moment je n'ai pas d'idée de suite ou autre pour ce projet, si vous en avez je suis à l'écoute.
