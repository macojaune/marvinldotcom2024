...
Je n'avais pas à l'époque, _(et n'ai toujours pas)_ de stratégie d'acquisition, ni même l'envie de chercher de nouveaux clients _(on en reparlera dans un article dédié) du coup pas de grand changements à mettre en place ce sera une refonte rapide._
...
Un framework orienté Contenu qui me permet d'utiliser n'importe quel autre framework UI _(react, vue…)_ ? Voire même plusieurs ? En même temps ? Ok ça m'intrigue.
...
_(je rajouterai peut-être un bouton pour changer rapidement, un de ces 4)_
...
Sens-toi libre de me dire ce que t'en penses sur le réseau qui te plait, _(un peu la flemme d'ajouter une gestion de commentaires ici…)_
