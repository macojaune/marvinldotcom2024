...
export const VoteResults = ({
  ...
  return (
    <div>
      <h2 className='mb-2 mt-8 w-fit px-2 text-2xl font-bold text-l/primary dark:bg-d/secondary dark:text-d/primary lg:mt-12'>
        Classement
      </h2>
      {data
      ...
      <>
        {showResults ? (
          ...
          <div className='mx-auto my-4'>
            ...
            <p className='text-right text-sm text-l/primary dark:text-d/primary'>
